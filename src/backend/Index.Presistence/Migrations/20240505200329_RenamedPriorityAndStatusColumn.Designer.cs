...
namespace Index.Presistence.Migrations
{
    ...
    [Migration("20240505200329_RenamedPriorityAndStatusColumn")]
    partial class RenamedPriorityAndStatusColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Index.Domain.Entities.SubjectModule.Assignment", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2024, 5, 5, 22, 3, 29, 153, DateTimeKind.Local).AddTicks(3336));
            ...
            modelBuilder.Entity("Index.Domain.Entities.SubjectModule.AssignmentGroup", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 5, 22, 3, 29, 153, DateTimeKind.Local).AddTicks(7006));
            ...
            modelBuilder.Entity("Index.Domain.Entities.SubjectModule.ReportCard", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 5, 22, 3, 29, 154, DateTimeKind.Local).AddTicks(5131));
